...
let rivne = document.getElementById("rivne");
//
  ...
  switch (isModalOn) {
    case true:
      ...
      switch (region) {
        ...
        case "rivne":
          rivne.style.cssText = "display: block;";
          break;
      }
      break;
    case false:
      ...
      rivne.style.cssText = "display: none;";
      break;
  }
}
...
$("#mask").click(function () {
  ...
  zakarpattia.style.cssText = "display: none;";
  ternopil.style.cssText = "display: none;";
  rivne.style.cssText = "diplay: none;";
});
...
// Pointer7 animation
$("#pointer7").mouseover(function () {
  $("#Fill-9").css("fill", "#f89924");
});
$("#pointer7").mouseout(function () {
  $("#Fill-9").css("fill", "#f8ca24");
});
